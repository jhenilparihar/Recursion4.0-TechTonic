  ...
  return (
    <div className="w-[500px] h-auto p-[20px] bg-[#12131A] text-white flex flex-col gap-y-[20px] rounded-lg m-auto mt-20">
      ...
      <form onSubmit={onCreateAccountHandler}>
        ...
        <button
          className="min-w-[200px] m-auto bg-primaryBlue py-[8px] px-[24px] rounded-lg text-white font-inter font-medium self-start border-[1px] mt-[40px]"
      ...
      <div className="text-center text-[14px] mt-[20px]">
        Powered by VisualVault
      </div>
    </div>
  );
};
